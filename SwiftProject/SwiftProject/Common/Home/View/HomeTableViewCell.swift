...
class HomeTableViewCell: UITableViewCell {
    ...
    func assignToViews(num:NSInteger) {
        ...
        //        let randomNumberTwo:Int = Int(arc4random_uniform(6))+1
                ...
                contentLabel.text = titleArray[num] as? String
        ...
        //            利用Kingfisher加载图片
                    imageV.kf.setImage(with: URL(string:imageArray[index] as! String)!)
                    imageV.tag = index
    ...
    //查看大图
     @objc func viewTheBigImage(ges:UITapGestureRecognizer) {
        ...
        for index in 0...theNum - 1 {
            showImages.add(imageArray[index])
        }
    ...
    @IBAction func likeAction(_ sender: UIButton) {
        ...
        if sender.titleLabel?.text?.count == 6 {
            setToast(str: "你赞了他一下")
